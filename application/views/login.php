				...
				<div class="auth-box ">
					<div class="left">
						<div class="content" style="width:300px;">
							<div class="header">
								<div class="logo text-center"><img style="width:130px;height:90px;" src="<?= base_url()?>assets/img/logomakan2.jpg" alt="Klorofil Logo"></div>
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">Makan Makanan yang bergizi</h1>
							<p>Dan Sehat</p>
						</div>
					</div>
