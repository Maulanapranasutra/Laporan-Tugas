Kuliner Mbak Siti<br>
Kuliner ternikmat<br>
...
<table border="1px solid black" style="border-collapse: collapse;">
	...
	<td><?= $no?></td><td><?= $dts->makanan?></td><td><?= number_format($dts->harga)?></td><td><?= $dts->jumlah?></td><td><?= number_format($dts->harga*$dts->jumlah)?></td>
